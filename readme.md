...
Require this package in your composer.json and run composer update (or run `composer require psqq/laravel-translation-manager` directly):

    composer require psqq/laravel-translation-manager
